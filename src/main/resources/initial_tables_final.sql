...
CREATE TABLE DISEASE (
    ...
    CONSTRAINT FK_METASTATIC_SITE_DISEASE FOREIGN KEY (DISEASE_METASTATICSITE) REFERENCES METASTATICSITE(METS_ID),
    CONSTRAINT FK_OTHER_SITE_DISEASE FOREIGN KEY (DISEASE_OTHERSITE) REFERENCES BODYSITE(BODYSITE_ID),

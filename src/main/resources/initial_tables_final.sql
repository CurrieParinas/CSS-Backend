...
CREATE TABLE WORKUP (
    ...
    CONSTRAINT FK_CANCER_TYPE_WORKUP FOREIGN KEY (CANCER_TYPE) REFERENCES BODYSITE(BODYSITE_ID)
);
...
CREATE TABLE LABMONITOR (
    ...
    LAB_SUBMITTED_ID NUMBER,
    END_DATE DATE,
    STATUS VARCHAR2(10),
    CONSTRAINT FK_LAB_SUBMITTED_ID_LABMONITOR FOREIGN KEY (LAB_SUBMITTED_ID) REFERENCES LABSUBMITTED(LABSUBMITTED_ID)
);
...
CREATE TABLE SYMPTOM_REPORT_RELATION_TABLE(
    RELATION_ID NUMBER PRIMARY KEY,
    SYMPTOMSURVEY_ID NUMBER,
    SURVEYRESPONSE_ID NUMBER,
    CREATED_AT TIMESTAMP,
    UPDATED_AT TIMESTAMP,
    FOREIGN KEY (SYMPTOMSURVEY_ID) REFERENCES SYMPTOMSURVEY(SYMPTOMSURVEY_ID),
    FOREIGN KEY (SURVEYRESPONSE_ID) REFERENCES SURVEYRESPONSE(SURVEYRESPONSE_ID)
);

CREATE SEQUENCE SYMPTOM_REPORT_RELATION_TABLE_SEQ
    INCREMENT BY 1
    START WITH 1
    MINVALUE 1;
